"""
Django settings for apesf_site project.
...
SECRET_KEY = 'django-insecure-4ymgt$##**$--m((ehxu+!0rhmpuw02m3k-&*!x4w37&lt6q*='
...
WSGI_APPLICATION = 'apesf_site.wsgi.application'
...
AUTH_PASSWORD_VALIDATORS = [
    ...
    {
        'NAME': 'apesf.validators.ComplexPasswordValidator',  #Chemin vers le validateur du fichier validators.py
    },
]
...
STATIC_URL = '/static/'
STATICFILES_DIRS = [
    BASE_DIR / "apesf/static",
    BASE_DIR / "theme" / "static",  # Ajout pour inclure les fichiers générés par django-tailwind
]
...
# Configuration de django-tailwind
